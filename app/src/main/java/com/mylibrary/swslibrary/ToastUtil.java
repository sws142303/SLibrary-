...
public class ToastUtil {
    ...
    private ToastUtil() {
        throw new RuntimeException(String.format("No instantiate %s", getClass().getSimpleName()));
    }
     ...
     * @param xOffset X轴偏移量(单位：px)
     * @param yOffset Y轴偏移量(单位：px)
     */
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(Utils.getsApplication().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(Utils.getsApplication().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = Toast.makeText(Utils.getsApplication(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = new Toast(Utils.getsApplication());
                sToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate = (LayoutInflater) Utils.getsApplication().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
